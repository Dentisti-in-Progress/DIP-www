...
//
// Le theme est bilingue par defaut (italien, anglais). Pour en ajouter une
...
// se contente de leur ajouter le prefixe de langue. Qui veut /en/journal/
...
export interface LocaleMeta {
  ...
  intl: string;
  /** Drapeau ? Non. Un drapeau designe un pays, pas une langue. Deux lettres,
   *  c'est plus honnete et
   *  ca ne casse pas sur les polices systeme. */
  short: string;
}

export const localeMeta: Record<Locale, LocaleMeta> = {
  it: { label: "Italiano", htmlLang: "it", dir: "ltr", intl: "it-IT", short: "IT" },
